...
class Hero:
    ...
    def set_hp(self, new_value):    # установить здоровье
        self.__hp = max(new_value, 0)

    def get_power(self):    # получить силу
        return self.__power

    def set_power(self, new_power):     # установить силу
...
class Healer(Hero):
    ...
    # ОДНО из действий(атака, исцеление) на выбранную им цель
    def __init__(self, name):
        super().__init__(name)
...
class Tank(Hero):
    ...
    # и на основе своей стратегии выполняет ОДНО из действий
    # (атака, поднять щит/опустить щит) на выбранную им цель
...
class Attacker(Hero):
    ...
    # на половину коэффициента усиления урона - damage * (self.power_multiply / 2)
    ...
    # - выбор действия - получает на вход всех союзников и всех врагов
    # и на основе своей стратегии выполняет ОДНО из действий
    # (атака, усиление, ослабление) на выбранную им цель
