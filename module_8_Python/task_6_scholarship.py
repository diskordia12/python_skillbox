...
# family_money = expenses - educational_grant
family_money = 0

for month in range(1, 10 + 1):
    family_money += expenses - educational_grant
    print(f'{month} месяц траты {round(expenses, 2)} и не хватает {round(family_money, 2)}')
...
print(f'Нужно попросить у родителей {round(family_money, 2)}')
