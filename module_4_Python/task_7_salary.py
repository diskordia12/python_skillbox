...
# у пользователя три числа: количество отработанных часов, остаток
# по кредиту и количество денег на еду. После этого рассчитывается зарплата
# по формуле. Если зарплата больше или равна сумме, которая требуется на кредит и еду,
# то выводится сообщение: «Часов хватает. Можно отдохнуть». В противном случае:
...
hours = int(input('Enter amount hours: '))
credit = int(input('Enter credit: '))
food = int(input('Enter amount money for food: '))
salary =  (200 * hours)/(2**3)+hours

if salary >= credit + salary:
    print('Enough hours. You can rest!')
else:
    print('There are not enough hours. Will have to work harder!')
