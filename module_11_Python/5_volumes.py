...
radius = float(input('Enter a radius of a planet: '))
...
if planet_volume < earth_volume:
    print(f'Volume of Earth is {round(earth_volume / planet_volume, 3)} times more')
else:
    print(f'Volume of Earth is {round(planet_volume / earth_volume, 3)} times less')
